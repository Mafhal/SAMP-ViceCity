...
{
	SendClientMessage(playerid, COLOR_CLIENT, "ANIMAÇÃO:{FFFFFF} /dancar, /renderse, /tapinha, /bar, /bomba, /animped");
	SendClientMessage(playerid, COLOR_CLIENT, "ANIMAÇÃO:{FFFFFF} /carry, /crack, /dormir, /deal, /comer, /vomitar, /gsign, /chat.");
...
CMD:cansado(playerid, params[])
{
	...
	if (type < 1 || type > 2) return SendErrorMessage(playerid, "Tipo especificado inválido.");
...
CMD:andar(playerid, params[])
{
	...
	if (type < 1 || type > 17) return SendErrorMessage(playerid, "Tipo especificado inválido.");
...
CMD:bat(playerid, params[])
{
	...
	if (type < 1 || type > 5)
	    return SendErrorMessage(playerid, "Tipo especificado inválido.");
